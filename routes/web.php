...
Route::get('/empleo/{id}', [EmpleoController::class,'update'])->name('empleo.update')->middleware('auth');
Route::get('/empleo/{id}', [EmpleoController::class,'destroy'])->name('empleo.destroy')->middleware('auth');
Route::post('/empleo/{id}', [EmpleoController::class,'update'])->name('empleo.update')->middleware('auth');
